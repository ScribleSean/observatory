...
const event=(id,requestId,usage,{timestamp='2026-09-25T04:30:00Z',model='claude-sonnet-4-20250514'}={})=>JSON.stringify({timestamp,requestId,message:{role:'assistant',id,model,usage,content:'PRIVATE'}})+'\n';
