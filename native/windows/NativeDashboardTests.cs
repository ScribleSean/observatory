    ...
    internal static void Run(string output)
    {
        ...
        form.Shown += async (_, _) =>
        {
            try
            {
                ...
                const string paceSummary = "20.0% of allowance/hour over 60 min. Approximately 2h 30m left at this pace (at last check).";
                data["quota"]!["pace"] = new JsonArray(new JsonObject { ["bucket"] = "codex", ["window"] = "primary", ["asOf"] = freshAt, ["summary"] = paceSummary });
                form.Reload();
